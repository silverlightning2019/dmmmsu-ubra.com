            ...
            <form class="col s12">
              <div class="row">
                ...
                <div class="input-field col s12 m6">
                  <input placeholder="Job Position" id="job_position" name="job_position" type="text" class="validate" value="<?php echo $row["job_position"]; ?>">
                  <label for="jobtitle">Job Position</label>
                </div>

                <div class="input-field col s12 m6">
                  <input placeholder="Location" id="job_location" name="job_location" type="text" class="validate" value="<?php echo $row["job_location"]; ?>">
                  <label for="job_location">Location</label>
                </div>

                <div class="input-field col s12 m6">
                  <input placeholder="Company/Employer" id="employer" name="employer" type="text" class="validate" value="<?php echo $row["employer"]; ?> ">
                  <label for="Date">Company/Employer</label>
                </div>

                <div class="input-field col s12 m6">
                  <input placeholder="Job Position Available" id="available" name="available" type="text" class="validate" value="<?php echo $row["available"]; ?> ">
                ...
                <div class="center ">
                  ...
                  <a id="updatejob" name="updatejob" class="btn btn-medium waves-effect waves-light blue"><i class="material-icons">navigate_next</i></a>
                </div>
              </div>
            </form>
          </div>
