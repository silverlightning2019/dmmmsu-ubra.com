            ...
            <form class="col s12">
              <div class="row">
                ...
                <div class="input-field col s12">
                  <input placeholder="Other Notes" id="notes" name="notes" type="text" class="validate">
                </div>

                <div class="center">
                  <a class="btn btn-medium waves-effect blue disabled"><i class="material-icons">navigate_before</i></a>
                  <a id="addnotes" name="addnotes" class="waves-effect btn blue darken-4"><i class="material-icons left">post_add</i>Post</a>
                </div>
              </div>
            </form>
          </div>
