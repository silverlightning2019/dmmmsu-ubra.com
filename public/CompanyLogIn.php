				...
				<form action="" method="">
					<div class="card-panel z-depth-5">
						...
						<div class="input-field col s12">
							...
							<input type="email" name="email" class="validate" placeholder="Enter Username">
						</div>
						...
						<p class="right-align">Create Account?<a href="CompanyRegistration.html" class="blue-text click">Register Here Employer!</a></p>
