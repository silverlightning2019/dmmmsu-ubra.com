  ...
  <div class="container">
    <h1 class="header center blue-grey-text">Job Categories</h1>
      ...
      <div class="col s12 m4">
            ...
            <div class="card hoverable">
              <div class="icon-block icon">
                <h2 class="center light-blue-text"><i class="material-icons">construction</i></h2>
                  <h5 class="center black-text">Construction</h5>
                    <p class="center black-text">(1 Jobs)</p> 
            </div>
            </a>
          </div>
            ...
            <div class="card hoverable">
              <div class="icon-block icon">
                <h2 class="center light-blue-text"><i class="material-icons">school</i></h2>
                  <h5 class="center black-text">Educational</h5>
                    <p class="center black-text">(1 Jobs)</p> 
            </div>
            </a>
          </div>
      ...
      <div class="col s12 m4">
            ...
            <div class="card hoverable">
              <div class="icon-block icon">
                <h2 class="center light-blue-text"><i class="material-icons">fastfood</i></h2>
                  <h5 class="center black-text">Restaurant/Food Service</h5>
                    <p class="center black-text">(1 Jobs)</p> 
            </div>
            </a>
          </div>
            ...
            <div class="card hoverable">
              <div class="icon-block icon">
                <h2 class="center light-blue-text"><i class="material-icons">business</i></h2>
                  <h5 class="center black-text">Sales & Marketing</h5>
                    <p class="center black-text">(1 Jobs)</p> 
            </div>
            </a>
          </div>
            ...
            <div class="card hoverable">
              <div class="icon-block icon">
                <h2 class="center light-blue-text"><i class="material-icons">language</i></h2>
                  <h5 class="center black-text">IT Solutions</h5>
                    <p class="center black-text">(1 Jobs)</p> 
            </div>
            </a>
          </div>
